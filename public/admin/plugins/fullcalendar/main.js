...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // Event Handling
    // ----------------------------------------------------------------------------------------------------------------
    // if intercepting bubbled event at the document/window/body level,
    ...
    */
    ...
    function expandRecurring(eventStore, framingRange, context) {
        ...
        // TODO: bad. always expand event as a second step
    ...
    */
    ...
    function buildEventRangeKey(eventRange) {
        ...
        // inverse-background event don't have specific instances. TODO: better solution
    }
    ...
    */
    ...
    var MINIMAL_RAW_EN_LOCALE = {
        ...
        allDayText: 'all-day',
        moreLinkText: 'more',
        noEventsText: 'No event to display',
    };
    ...
    */
    ...
    function reduceEventStore(eventStore, action, eventSources, dateProfile, context) {
        switch (action.type) {
            ...
            case 'REMOVE_ALL_EVENT_SOURCES':
                return filterEventStoreDefs(eventStore, function (eventDef) { return (!eventDef.sourceId // only keep event with no source id
                ); });
    ...
    */
    var EventClicking = /** @class */ (function (_super) {
        ...
        function EventClicking(settings) {
            ...
            _this.destroy = listenBySelector(settings.el, 'click', '.fc-event', // on both fg and bg event
    ...
    */
    var EventHovering = /** @class */ (function (_super) {
        ...
        function EventHovering(settings) {
            ...
            _this.removeHoverListeners = listenToHoverBySelector(settings.el, '.fc-event', // on both fg and bg event
        ...
        function CalendarContent() {
            ...
            _this.handleWindowResize = function (ev) {
                ...
                if (options.handleWindowResize &&
                    ev.target === window // avoid jqui event
                ) {
    ...
    var Slicer = /** @class */ (function () {
        ...
        */
        Slicer.prototype.sliceEventRange = function (eventRange, extraArgs) {
            ...
            // hack to make multi-day event that are being force-displayed as list-items to take up only one day
    ...
    */
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        // exclude the subject event. TODO: exclude defs too?
                ...
                if (_this.validMutation) {
                    ...
                    var eventChangeArg = {
                        ...
                        revert: function () {
                            context.dispatch({
                                type: 'MERGE_EVENTS',
                                eventStore: relevantEvents, // the pre-change event
                            });
                        },
                    };
    ...
    */
        ...
        TableCell.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl }, function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) { return (createElement("td", __assign({ ref: dayElRef, role: "gridcell", className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs, (props.showDayNumber ? { 'aria-labelledby': state.dayNumberId } : {})),
                createElement("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                    ...
                    createElement("div", { className: "fc-daygrid-day-event", ref: props.fgContentElRef },
                        props.fgContent,
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        function TableRow() {
            ...
            _this.fgElRefs = new RefMap(); // the fc-daygrid-day-event
        ...
        TableRow.prototype.renderFgSegs = function (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++) {
                    ...
                    /*
                    known bug: event that are force to be list-item but span multiple days still take up space in later columns
                    todo: in print view, for multi-day event, don't display title within non-start/end segs
                    */
        ...
        TableRow.prototype.updateSizing = function (isExternalSizingChange) {
            ...
            if (!props.forPrint &&
                ...
                this.setState({
                    // HACK to prevent oscillations of event being shown/hidden from max-event-rows
                    // Essentially, once you compute an element's height, never null-out.
                    // TODO: always display all event, as visibility:hidden?
        ...
        TimeCol.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) { return (createElement("td", __assign({ ref: rootElRef, role: "gridcell", className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-timegrid-col-frame" },
                    ...
                    createElement("div", { className: "fc-timegrid-col-event" }, _this.renderFgSegs(sortedFgSegs, interactionAffectedInstances, false, false, false)),
                    createElement("div", { className: "fc-timegrid-col-event" }, _this.renderFgSegs(mirrorSegs, {}, Boolean(props.eventDrag), Boolean(props.eventResize), Boolean(isSelectMirror))),
    ...
    */
    ...
    function buildUrl(meta) {
        ...
        return apiBase + '/' + encodeURIComponent(meta.googleCalendarId) + '/event';
    }
    function buildRequestParams(range, apiKey, extraParams, dateEnv) {
        ...
        if (dateEnv.canComputeOffset) {
            ...
            // from the UTC day-start to guarantee we're getting all the event
