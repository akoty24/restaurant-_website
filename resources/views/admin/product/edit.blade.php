        ...
        <form action="{{ route('product.update',$products->id) }}" method="POST"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="desc" id="exampleInputDescription" cols="30" rows="5">{{ $products->desc }}</textarea>
                </div>
                <div class="form-group">
                    <label for="exampleInputDescription">Category</label>

                    <select class="form-control select2" name="category_id" style="width: 100%;">
                        <option value="{{ $products->category_id }}" selected="selected">
                            {{ $products->categories->name ?? '' }}</option>
                    </select>
                ...
                <img src="{{ url('admin/img/product/'.$products->image)}}" width="150px" style="margin-left:40%" alt="">
            </div>
        </form>
    </div>
    <!-- /.card -->
